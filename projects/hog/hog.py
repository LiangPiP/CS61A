...
def play(strategy0, strategy1, update,
    ...
    while score0<goal and score1<goal:
        if who==0:
            ...
            score0=update(num_rolls, score0, score1, dice=dice)
        else:
            num_rolls=strategy1(score1,score0)
            score1=update(num_rolls, score1, score0, dice=dice)
        who=1-who
    # END PROBLEM 5d
...
def make_averaged(original_function, total_samples=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    def ave_original_function(*args):
        sum,i=0,0
        while i<total_samples:
            sum+=original_function(*args)
            i+=1
        return sum/total_samples
    return ave_original_function
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    # BEGIN PROBLEM 9 s
    "*** YOUR CODE HERE ***"
    best,i,max_score=1,1,0
    while i<=10:
        score=make_averaged(roll_dice,total_samples=total_samples)(i,dice)
        if score>max_score:
            max_score=score
            best=i
        i=i+1
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if score<40:
        ...
        return tail_strategy(score, opponent_score, threshold=12, num_rolls=6)
    else:
